...
void continueAfterSETUP(RTSPClient* rtspClient, int resultCode, char* resultString) {
  do {
    ...
    scs.subsession->sink = DummySink::createNew(env, *scs.subsession, rtspClient->url(), rtspClient);
...
DummySink* DummySink::createNew(UsageEnvironment& env, MediaSubsession& subsession, char const* streamId, RTSPClient* rtspClient) {
  return new DummySink(env, subsession, streamId, rtspClient);
}

DummySink::DummySink(UsageEnvironment& env, MediaSubsession& subsession, char const* streamId, RTSPClient* rtspClient)
  : MediaSink(env),
...
/* onCreate rtsp client env set */
void
waptestRtspClient::onCreate(char const* progName, char const* rtspURL)
{
